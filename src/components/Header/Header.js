...
export default function PageHeader () {
    ...
    useEffect(() => {
        if ( currentUser.username ) {
            setLinks([
                ...
                { id: 1, title: 'My Investments', link: '/my-investments' },
                { id: 2, title: 'Add Investment', link: '/add-investment' },
                { id: 3, title: 'Profile', link: '/profile' },
                { id: 4, title: 'Sign Out', link: '/sign-out' }
            ]);
        } else {
            setLinks([
                { id: 0, title: 'About', link: '/about-us' },
    ...
    return (
        <nav className='page-navigation' >
            ...
            <NavItem links={links} history={history} />
        </nav>
    );
}